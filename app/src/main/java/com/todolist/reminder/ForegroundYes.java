...
public class ForegroundYes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(modelList==null){
            ...
            Toast.makeText(ForegroundYes.this,"Error",Toast.LENGTH_LONG).show();

        }else{
            Toast.makeText(ForegroundYes.this,"Task is: "+modelList.get(modelList.size()-1).getTaskName(),Toast.LENGTH_LONG).show();
        ...
        mainBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(ForegroundYes.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        statsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(ForegroundYes.this,StatsActivity.class);
                startActivity(i);
            }
        });
