...
public class NotificationNo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(modelList==null){
            ...
            Toast.makeText(NotificationNo.this,"Error",Toast.LENGTH_LONG).show();

        }else{
            Toast.makeText(NotificationNo.this,"Task is: "+modelList.get(modelList.size()-1).getTaskName(),Toast.LENGTH_LONG).show();
            tempModel=modelList.get(modelList.size()-1);
            tempModel.setTaskComplete(false);
        ...
        mainBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(NotificationNo.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        statsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(NotificationNo.this,StatsActivity.class);
                startActivity(i);
            }
        });
